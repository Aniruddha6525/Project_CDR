...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 overflow-x-hidden font-sans">
      ...
      {/* Footer / Status Bar - Fixed Details */}
      <footer className="fixed bottom-0 w-full border-t border-border/40 bg-background/80 backdrop-blur-xl py-2.5 px-6 text-[10px] text-muted-foreground flex justify-between items-center z-40 font-mono uppercase tracking-widest shadow-[0_-4px_24px_rgba(0,0,0,0.1)]">
