        ...
        <div className="bg-secondary/40 backdrop-blur-md p-1.5 rounded-2xl border border-border/50 flex relative shadow-inner">
            <button
                ...
                className={clsx(
                    ...
                    currentMode === 'fingerprint' ? "text-primary-foreground bg-primary shadow-lg shadow-primary/25" : "text-muted-foreground/90 hover:text-foreground hover:bg-muted/50"
                )}
            >
            ...
            <button
                ...
                className={clsx(
                    "flex-1 flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl text-sm font-bold tracking-wide transition-all duration-300 relative z-10",
                    currentMode === 'hybrid' ? "text-primary-foreground bg-primary shadow-lg shadow-primary/25" : "text-muted-foreground/90 hover:text-foreground hover:bg-muted/50"
                )}
            >
